...
[![Citation](https://img.shields.io/badge/citation-BibTeX-778899)](https://ohno.github.io/Antique.jl/blob/main/CITATION.bib)
...
Or run `import Pkg; Pkg.add(; name="Antique", version="0.13.0")` to install on Jupyter Notebook. The version of this package can be found at `]status Antique` or `import Pkg; Pkg.status("Antique")`.
