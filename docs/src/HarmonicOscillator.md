...
``n=3:`` ✗
Hₙ(x) = (-1)ⁿ exp(x²) dⁿ/dxⁿ exp(-x²) = ...: Test Failed at C:\Users\user\Desktop\GitHub\Antiq.jl\test\HarmonicOscillator.jl:43
  Expression: acceptance

Stacktrace:
 [1] macro expansion
   @ C:\Users\user\.julia\juliaup\julia-1.9.2+0.x64.w64.mingw32\share\julia\stdlib\v1.9\Test\src\Test.jl:478 [inlined]
 [2] macro expansion
   @ C:\Users\user\Desktop\GitHub\Antiq.jl\test\HarmonicOscillator.jl:43 [inlined]
 [3] macro expansion
   @ C:\Users\user\.julia\juliaup\julia-1.9.2+0.x64.w64.mingw32\share\julia\stdlib\v1.9\Test\src\Test.jl:1498 [inlined]
 [4] top-level scope
   @ C:\Users\user\Desktop\GitHub\Antiq.jl\test\HarmonicOscillator.jl:28
```math
\begin{aligned}
  H_{3}(x)
...
in expression starting at C:\Users\user\Desktop\GitHub\Antiq.jl\test\HarmonicOscillator.jl:27
```
