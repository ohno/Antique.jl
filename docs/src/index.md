...
Or run `import Pkg; Pkg.add(; name="Antique", version="0.14.0")` to install on Jupyter Notebook. The version of this package can be found at `]status Antique` or `import Pkg; Pkg.status("Antique")`.
