...
@testset "CTB: <r> = ∫r|Rₙₗ(r)|²r²dr = (a₀×mₑ/μ)/2Z × [3n²-l(l+1)]" begin
    for CTB in [
            ...
            CoulombTwoBody(z_1 = -1, z_2 = +1, m_1 = 1.0, m_2 = 206.768283),
            CoulombTwoBody(z_1 = -1, z_2 = +1, m_1 = 1.0, m_2 = 1836.15267343),
            CoulombTwoBody(z_1 = -1, z_2 = +1, m_1 = 1.0, m_2 = Inf),
            CoulombTwoBody(z_1 = -1, z_2 = +1, m_1 = 206.768283, m_2 = 1836.15267343),
            CoulombTwoBody(z_1 = -1, z_2 = +2, m_1 = 206.768283, m_2 = 7294.29954142),
        ]
        println(io, CTB)
        println(io, " n |  l |     analytical |      numerical ")
        println(io, "-- | -- | -------------- | -------------- ")
